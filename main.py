...
SoupPuzzle = Puzzle("soup", get_room_object("soup"), [get_item_object(
    "carrot"), get_item_object("goldfish"), get_item_object("pretzel")], SoupDictionary)
...
def parse(inputCommand):
    ...
    if soup_puzzle_complete(SoupPuzzle):
        ...
        get_room_object("kitchen").set_look(
